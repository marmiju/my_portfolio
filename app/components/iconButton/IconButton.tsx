...
export const IconButton = ({ social }: { social: Social }) => {
  ...
  return (
    <a href={social.link} target="_blank">
      <div className="group flex border-white hover:bg-white border shadow-md rounded-full items-center gap-2 min-w-[40px] w-10 transition-all duration-1000 ease-in-out hover:w-fit">
        <Image
          src={social.img}
          alt={social.title || "Social icon"}
          width={40}
          height={40}
        />
